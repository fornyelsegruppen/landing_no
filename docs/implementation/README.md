...
- [F11 – withdrawal, change and controlled customer recovery](./phase-f11-withdrawal-change-recovery.md) — teknisk implementert; staging UAT gjenstår
- [F10 pilot evidence template](../operations/f10-pilot-evidence-template.md)
- [Admin Next + Roof Fusion Preview gate 2026-09-03](./admin-next-roof-fusion-preview-gate-2026-09-03.md) — `IMPLEMENTED / PENDING_OWNER_UAT`, Production `NO_GO`
- [SEO manual Preview canary 2026-09-03](./seo-manual-preview-canary-2026-09-03.md) — `MANUAL_PREVIEW_CANARY_PASS`; scheduler canary pending, Production `NO_GO`
