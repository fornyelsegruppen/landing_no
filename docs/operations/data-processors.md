...
| OpenStreetMap / Overpass | gratis bygningskontur til foreløpig takestimat | koordinat rundt normalisert adresse; ikke navn, telefon eller e-post | 80 m radius, lavt volum, admin velger bygg, ODbL-kreditering lagres | vilkår/attribusjon, fallback og fysisk pilotkontroll |
