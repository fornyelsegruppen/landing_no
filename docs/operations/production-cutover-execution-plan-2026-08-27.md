...
| PROD-7 Sintetinė Production užklausa | PAUSED / FIX READY | Pirmas aiškiai pažymėtas sintetinis formos pateikimas grąžino 500, todėl bandymas iškart sustabdytas ir nekartotas. Production DB nebuvo sukurta byla ir nebuvo išsiųstas laiškas. Priežastis: vieša forma siunčia `takvask_impregnering`, tačiau Production `enum_leads_type` šios reikšmės neturėjo. Paruošta addityvi idempotentinė migracija `20260827_090000_lead_inquiry_type_combined_service`: 2/2 tiksliniai testai, 36/36 visų migracijų testai, 537/537 unit/API testai, typecheck, lint ir Production build PASS. Šviežioje Production kopijoje `prod7-migration-qa-2026-08-27` (`br-shiny-smoke-aswur2m2`) migracija pridėjo vieną reikšmę, pakartotinis vykdymas liko saugus, o esamų bylų skaičius liko 7 → 7. Production deploy ir antras vienintelis sintetinis bandymas dar neatlikti | Techninė patikra; laukiamas savininko deploy patvirtinimas | 2026-08-27 11:44 EEST |
