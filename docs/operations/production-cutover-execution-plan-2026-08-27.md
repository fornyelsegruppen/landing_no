...
Data: 2026-08-27  
Būsena: **VYKDOMA — PROD-0–PROD-8.0 PASS; PROD-8.1 funkcijos dar neįjungtos**
...
| PROD-8 Laipsniškas funkcijų įjungimas | IN_PROGRESS — PROD-8.0 PASS | Safety-only Production `dpl_CWjdo63P3zdBmvFymZ3RwDnkmPXu`; rollback `dpl_DU2EPy99v6px53cQQfAqTYq3afHj`; Preview `dpl_Ep3DEjGjPyWiAxqDuYCWpFLCwoXQ`; code `6007e79` | Visi 13 flagų false, centrinė komunikacijos pauzė aktyvi, DB kopija ir rollback patikrinti, Gemini paruoštas su 10/100 limitais, 584 testai PASS, Preview/Production smoke PASS, `/meta.json` 404, 0×5xx, piloto juosta patvirtinta prisijungusio admin ir telefone. PROD-8.1 nepradėtas | Savininkas ir techninė patikra | 2026-08-27 12:59 Europe/Oslo |
