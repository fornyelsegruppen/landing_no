...
Data: 2026-08-27  
Būsena: **VYKDOMA — PROD-0–PROD-8.1 PASS; PROD-8.2 ir PROD-8.3 VERIFYING; PROD-8.4 PRECHECK**
...
| Ortofoto, jei vėliau aktyvuojama   | `NORGE_I_BILDER_WMS_LAYER`, `MAP_TERMS_ACCEPTED_AT` ir arba trumpalaikis `NORGE_I_BILDER_TOKEN` + `NORGE_I_BILDER_TOKEN_EXPIRES_AT`, arba serveriniai GeoID prisijungimai + HTTPS referer | neprivaloma baziniam scheminiam matavimo įrodymui |
...
| PROD-8 Laipsniškas funkcijų įjungimas  | IN_PROGRESS — 8.2/8.3 VERIFYING | Production `dpl_CvS7U3tgY16XmLss8aAciiKtZzK5`; Preview `dpl_2mBbVwymveu5Jjgw5qc39X7U3dPj`; pataisos kandidatas `c2989a1`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | 8.1 lieka PASS. Byla `#10` įrodė pagrindinį komercinį, dviejų parašų ir darbo paskyrimo kelią. 8.2/8.3 likę scenarijai ir 8.4 priklausomybės išvardyti [faktinės būsenos audite](./prod8-current-state-audit-2026-08-28.md); `mark_reviewed` Linux CI `33120965793` PASS, gyvas Preview UAT laukia prisijungimo | Savininkas ir techninė patikra | 2026-08-28 |
