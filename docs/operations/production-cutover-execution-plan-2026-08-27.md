...
Data: 2026-08-27  
Būsena: **VYKDOMA — PROD-0–PROD-6 PASS; PROD-7 sustabdytas ties P1, pataisymas patikrintas ir laukia atskiro Production deploy patvirtinimo**
...
| PROD-7 Sintetinė Production užklausa | PAUSED / FIX READY | Pirmas aiškiai pažymėtas sintetinis formos pateikimas grąžino 500, todėl bandymas iškart sustabdytas ir nekartotas. Production DB nebuvo sukurta byla ir nebuvo išsiųstas laiškas. Priežastis: vieša forma siunčia `takvask_impregnering`, tačiau Production užklausos enum šios reikšmės neturėjo. Paruošta addityvi idempotentinė migracija `20260827_090000_lead_inquiry_type_combined_service`, kuri nustato tikrą prie `leads.inquiry_type` prijungtą enum ir saugiai nieko nedaro, jei senoje/tuščioje aplinkoje lentelės dar nėra: 4/4 tiksliniai testai, 38/38 visų migracijų testai, 537/537 unit/API testai, typecheck, lint ir Production build PASS. Pirmoje šviežioje Production kopijoje `prod7-migration-qa-2026-08-27` (`br-shiny-smoke-aswur2m2`) reikšmė pridėta vieną kartą, pakartotinis vykdymas liko saugus, o esamų bylų skaičius liko 7 → 7. Antroje šviežioje kopijoje `prod7-migration-qa2-2026-08-27` (`br-winter-dream-as5paip3`) tikras Payload migracijos ir pilno Production build kelias PASS. Preview atskleidė alternatyvų istorinį enum pavadinimą; jis įtrauktas į testus ir suderinamą migracijos logiką. Production deploy ir antras vienintelis sintetinis bandymas dar neatlikti | Techninė patikra; laukiamas savininko deploy patvirtinimas | 2026-08-27 11:55 EEST |
