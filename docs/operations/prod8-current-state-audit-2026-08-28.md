...
| Pasiūlymo klausimas                                              | UAT BLOCKED – PATAISA VYKDOMA        | Preview byla `#16`: klausimas įrašytas, tačiau aktyvioje admin darbo vietoje nerodomas jo tekstas, prisegta būsena klaidina, o atsakymo juodraščio vykdymas nėra pakankamai tiesioginis. Taisoma automatinė, versijomis pagrįsta Gemini juodraščio, vieno redaktoriaus, administratoriaus patvirtinimo ir kliento pasirašymo blokavimo grandinė. |
