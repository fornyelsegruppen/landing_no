...
export const blogPromptVersion = "blog-article-nb-v3";
...
Bruk naturlig norsk fagspråk. Skriv for eksempel «sterkt begrodd med mose, lav eller alger», «ekstra sikkerhetstiltak» og «geografisk beliggenhet». Ikke skriv at impregnering styrker taksteinen. Bruk bare den forsiktige, godkjente formuleringen om redusert fuktopptak på egnet takstein. Ikke lov at en behandling forlenger levetiden; skriv at riktig behandling kan bidra når taket er teknisk egnet.
...
- Bruk CTA-en fra godkjent kunnskap. Ikke skriv at leseren skal «bestille en takfornying» for å få en faglig gjennomgang.
