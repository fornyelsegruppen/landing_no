...
const workerCopies = {
  nb: {
    ...
    internalNote: "Intern planleggingsmerknad",
  ...
  lt: {
    ...
    internalNote: "Vidinė planavimo pastaba",
  ...
  en: {
    ...
    internalNote: "Internal planning note",
    ...
    uploading: "Uploading …",
    registered: "Saved.",
    customerNotified: "Saved. The customer was notified.",
    customerNotificationQueued: "Saved. The customer notification is queued.",
