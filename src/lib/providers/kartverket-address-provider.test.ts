...
describe("Kartverket address provider", () => {
  ...
  it("blocks imagery until the approved server-capture controls are configured", () => {
    ...
    process.env.NORGE_I_BILDER_CAPTURE_APPROVAL_REFERENCE =
      "KARTVERKET-2026-09-02";
    process.env.NORGE_I_BILDER_CHROMIUM_PACK_URL =
      "https://storage.example/chromium-pack.tar";
