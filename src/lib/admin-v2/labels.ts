...
const statuses: Record<PanelLocale, Record<string, string>> = {
  nb: {
    new: "Ny", contacted: "Kontaktet", qualified: "Kvalifisert", measuring: "Måles", draft_ready: "Utkast klart", waiting_customer: "Venter på kunden", converted: "Bekreftet kunde", closed: "Lukket",
