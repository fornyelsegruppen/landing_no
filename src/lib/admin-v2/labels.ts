...
const types: Record<PanelLocale, Record<string, string>> = {
  nb: { lead: "Henvendelse", message: "Melding", measurement: "Takmåling", price: "Prisberegning", quote: "Tilbud", contract: "Kontrakt", contract_request: "Angre- eller endringsmelding", document: "Dokument", work: "Arbeid", change: "Endringsavtale", invoice: "Fakturautkast", warranty: "Garanti" },
  lt: { lead: "Užklausa", message: "Žinutė", measurement: "Stogo matavimas", price: "Kainos skaičiavimas", quote: "Pasiūlymas", contract: "Sutartis", contract_request: "Atsisakymo arba pakeitimo pranešimas", document: "Dokumentas", work: "Darbas", change: "Pakeitimų susitarimas", invoice: "Sąskaitos juodraštis", warranty: "Garantija" },
  en: { lead: "Enquiry", message: "Message", measurement: "Roof measurement", price: "Price calculation", quote: "Quote", contract: "Contract", contract_request: "Withdrawal or change notice", document: "Document", work: "Work", change: "Change agreement", invoice: "Invoice draft", warranty: "Warranty" },
};

const metadata: Record<PanelLocale, Record<string, string>> = {
  nb: { inbound: "Innkommende", outbound: "Utgående", email: "E-post", sms: "SMS", receipt: "Mottaksbekreftelse", ai_reply: "AI-svar", quote: "Tilbud", contract: "Kontrakt", customer: "Kunde", measurement: "Måling", work: "Arbeidsdokumentasjon", warranty: "Garanti", customer_question: "Kundespørsmål", follow_up: "Oppfølging", information_request: "Informasjonsforespørsel", completion: "Sluttdokumentasjon", invoice: "Faktura", reminder: "Påminnelse" },
  lt: { inbound: "Gaunama", outbound: "Siunčiama klientui", email: "El. paštas", sms: "SMS", receipt: "Užklausos patvirtinimas", ai_reply: "DI atsakymas", quote: "Pasiūlymas", contract: "Sutartis", customer: "Klientas", measurement: "Matavimas", work: "Darbų dokumentacija", warranty: "Garantija", customer_question: "Kliento klausimas", follow_up: "Tolesnis susisiekimas", information_request: "Informacijos prašymas", completion: "Baigiamieji dokumentai", invoice: "Sąskaita", reminder: "Priminimas" },
  en: { inbound: "Inbound", outbound: "Outbound", email: "Email", sms: "SMS", receipt: "Receipt", ai_reply: "AI reply", quote: "Quote", contract: "Contract", customer: "Customer", measurement: "Measurement", work: "Work documentation", warranty: "Warranty", customer_question: "Customer question", follow_up: "Follow-up", information_request: "Information request", completion: "Completion documents", invoice: "Invoice", reminder: "Reminder" },
};
