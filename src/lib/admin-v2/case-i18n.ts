...
const copy = {
  nb: {
    ...
    completionReviewHelp: "Kontroller dokumentasjon, endelig pris og garantigrunnlag før kunden varsles.",
    ...
    actionLabels: {
      ...
      review_cancellation: "Vurder kanselleringsforespørselen",
  ...
  lt: {
    ...
    completionReviewHelp: "Prieš informuojant klientą patikrinkite dokumentus, galutinę kainą ir garantijos pagrindą.",
    ...
    actionLabels: {
      ...
      review_cancellation: "Peržiūrėti atšaukimo prašymą",
  ...
  en: {
    ...
    completionReviewHelp: "Review the evidence, final price and warranty basis before the customer is notified.",
    ...
    actionLabels: {
      ...
      review_cancellation: "Review cancellation request",
