...
export default async function WorkPage({ searchParams }: { searchParams: SearchParams }) {
  ...
  const result = await loadOperationalList(await getPayload(), "work", state, { page: parseAdminListPage(params.page) });
