...
const loadingCopy = {
  nb: "Laster canonical arbeidskø",
  lt: "Įkeliama canonical darbų eilė",
  en: "Loading canonical Work Queue",
} as const;

export default async function AdminNextWorkQueueLoading() {
  ...
  return (
    <div
      ...
      data-work-queue-load-state="pending"
    >
      <AdminAsyncFeedback
